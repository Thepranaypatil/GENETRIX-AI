...
export default function ContactSection() {
    return (
        <div id="ContactSection"  className="px-4 md:px-16 lg:px-24 xl:px-32">
            <SectionTitle text1="Contact" text2="Grow your channel" text3="Have quetions about our Ai ? Ready to scale your views ? Let's talk." />
