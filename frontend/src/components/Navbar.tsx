        ...
        <>
            ...
            >
                ...
                <div className="hidden md:flex items-center gap-8 transition duration-500">
                    ...
                    {
                        isLoggedIn ? <Link to="/mygenerations" className="hover:text-pink-500 transition">My Generations</Link>
                            : <Link to='/#about' className="hover:text-pink-500 transition">About</Link>
                    }

                    <Link to="/#ContactSection" className="hover:text-pink-500 transition">Contact us</Link>

                </div>
                <div className="flex items-center gap-2">
                    {isLoggedIn ? (
                        <div className="relative group">
                            <button className="rounde-full size-8 bg-white/20 border-2 border-white/10">
